...
// HydrodynamicsParameters
  ...
  class HydrodynamicsParameters
  {
    ...
    public: HydrodynamicsParameters();
     public:
    public: void SetDampingOn(bool _on);
...
// Hydrodynamics
  ...
  class Hydrodynamics
  { public:  Vector3 GetBuoyancyForce() const;
  
  /// \brief Get buoyancy torque only
  Vector3 GetBuoyancyTorque() const;
    /// \brief Constructor
    ///
    ...
    /// \return Wave drag force vector
    public: Vector3 GetWaveDragForce() const;
    
    /// \brief Get mesh-based buoyancy force
    /// \return Buoyancy force based on submerged mesh volume
    public: Vector3 GetMeshBuoyancyForce() const;
    
    /// \brief Get wave drag torque
    /// \return Wave drag torque vector
    public: Vector3 GetWaveDragTorque() const;
