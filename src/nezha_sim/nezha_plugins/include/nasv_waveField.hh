...
public:
  /// \brief Get the surface elevation at a point.
  /// \param[in] _x The x coordinate.
  /// \param[in] _y The y coordinate.
  /// \param[in] _time The current simulation time.
  /// \return The surface elevation at the point.
  double SurfaceElevation(double _x, double _y, double _time) const;
  
  /// \brief Get the surface elevation at a point using current time.
  /// \param[in] _x The x coordinate.
  /// \param[in] _y The y coordinate.
  /// \return The surface elevation at the point.
  double SurfaceElevation(double _x, double _y) const;
